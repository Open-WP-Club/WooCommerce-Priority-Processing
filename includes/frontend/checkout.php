...
?>
    <div id="wpp-priority-section" class="wpp-priority-section">
      <h3>⚡ <?php echo esc_html($section_title); ?></h3>
      <div class="wpp-priority-field-wrapper">
        <label class="wpp-priority-label">
          <input
            type="checkbox"
